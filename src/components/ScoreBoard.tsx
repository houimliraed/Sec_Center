      ...
      <div className="space-y-2">
        <div className="flex justify-between items-center p-2 bg-indigo-50 rounded">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">Raedxddd</span> {/* Changed from Pushpa Raj to Raed */}
          </div>
        ...
        <div className="flex justify-between items-center p-2 bg-purple-50 rounded">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">Fadi</span> {/* Changed from Appanna to Fadi */}
          </div>
        ...
        <div className="flex justify-between items-center p-2 bg-gray-100 rounded">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">Taher (Draws)</span> {/* Changed from Draws to Taher (Draws) */}
          </div>
